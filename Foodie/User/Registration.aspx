    ...
    <section class="book_section layout_padding">
        <div class="container">
            <div class="heading_container">
                ...
                <asp:Label ID="lblHeaderMsg" runat="server" Text="<h2>User Registration"></asp:Label>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ErrorMessage="Username is required" ControlToValidate="txtUsername"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:TextBox ID="txtUsername" runat="server" CssClass="form-control" placeholder="Enter Full Username"
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Mobile Number must have 8 digits"
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="PostCode must be of 4 digits"
